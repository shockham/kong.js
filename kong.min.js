...
var Textity=function(a,b,c,f,e,d){this.x=a;this.y=b;this.Text=c;this.Colour=f;this.Size=e;this.Alive=!0;this.layer=d||0};Textity.prototype.update=function(){};Textity.prototype.draw=function(a){a.font=this.Size+"px 'VT323'";a.fillStyle=this.Colour;a.fillText(this.Text,this.x,this.y)};var Rectity=function(a,b,c,f,e,d){this.x=a;this.y=b;this.Width=f;this.Height=e;this.Colour=c;this.Alive=!0;this.layer=d||0};Rectity.prototype.update=function(){};
...
var State=function(){this.Objects=[]};State.prototype.add=function(a){this.Objects[this.Objects.length]=a};State.prototype.remove=function(a){this.Objects.splice(this.Objects.indexOf(a),1)};State.prototype.update=function(a){for(var b in this.Objects)this.Objects[b].Alive&&this.Objects[b].update(a)};
...
Game.prototype.add_canvas=function(a,b,c,f,e){var d=document.createElement("canvas");d.id="game_canvas_"+a;d.width=b;d.height=c;d.style.width=f+"px";d.style.height=e+"px";d.style.position="absolute";d.style.backgroundColor="transparent";a=d.getContext("2d");a.font="40px Monofett";a.textBaseline="top";document.body.appendChild(d)};Game.prototype.update=function(a){this.State.update(a)};Game.prototype.draw=function(){this.State.draw()};
window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}();var _g_;Game.prototype.main=function(a){var b=Date.now(),c=b-then;this.draw();this.update(c/1E3);then=b;a&&(_g_=a);requestAnimFrame(function(){_g_.main()})};var then=Date.now();Game.prototype.start=function(){then=Date.now();this.main(this)};
Game.prototype.touching=function(a,b){return a.x<=b.x+b.Width&&b.x<=a.x+a.Width&&a.y<=b.y+b.Height&&b.y<=a.y+a.Height?!0:!1};Game.prototype.collide=function(a,b){if(a.x<=b.x+b.Width&&b.x<=a.x+a.Width&&a.y<=b.y+b.Height&&b.y<=a.y+a.Height){var c=b.x+b.Width-a.x,f=a.x+a.Width-b.x,e=b.y+b.Height-a.y,d=a.y+a.Height-b.y;(c||f)>(e||d)?a.x=c<f?b.x+b.Width:b.x-b.Width:a.y=e<d?b.y+b.Height:b.y-b.Height}};var Music=function(a){this.music=document.createElement("audio");this.music.src=a};
Music.prototype.play=function(){this.music.play()};Music.prototype.loop=function(){this.music.loop=!0;this.music.play()};var keysDown={};addEventListener("keydown",function(a){keysDown[a.keyCode]=!0},!1);addEventListener("keyup",function(a){delete keysDown[a.keyCode]},!1);var touches=[];addEventListener("touchstart",function(a){a.preventDefault();touches=a.touches},!1);addEventListener("touchend",function(a){a.preventDefault();touches=a.touches},!1);
