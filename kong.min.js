...
window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}();var _g_;Game.prototype.main=function(a){var b=Date.now(),c=b-then;this.draw();this.update(c/1E3);then=b;a&&(_g_=a);window.requestAnimFrame(function(){_g_.main()})};var then=Date.now();Game.prototype.start=function(){then=Date.now();this.main(this)};
...
Music.prototype.play=function(){this.music.play()};Music.prototype.loop=function(){this.music.loop=!0;this.music.play()};Music.prototype.stop=function(){this.music.pause()};var keysDown={};addEventListener("keydown",function(a){keysDown[a.keyCode]=!0},!1);addEventListener("keyup",function(a){delete keysDown[a.keyCode]},!1);var touches=[];addEventListener("touchstart",function(a){a.preventDefault();touches=a.touches},!1);
addEventListener("touchend",function(a){a.preventDefault();touches=a.touches},!1);addEventListener("mousedown",function(a){touches[0]=a},!1);addEventListener("mouseup",function(){touches[0]=null},!1);
